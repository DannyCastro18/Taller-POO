...
class Contacto {
  ...
  mostrarContacto() {
    for (let i = 0; i < this.numero.length; i++)
      console.log(
        "Nombre: " +
          this.numero[i].nombre +
          " Apellido: " +
          this.numero[i].apellido +
          " Teléfono: " +
          this.numero[i].telefono +
          " Correo: " +
          this.numero[i].correo
      );
  }
}
let numero = new Contacto();
let persona1 = new Agenda(
  "Camilo",
  "Vasquez",
  3006541231,
  "camivasquez@gmail.com"
);
let persona2 = new Agenda(
  "Xiomara",
  "Castillo",
  3157890234,
  "xiocastillo@gmail.com"
);
let persona3 = new Agenda(
  "Carmen",
  "Montenegro",
  3208764509,
  "carmenmontenegro@gmail.com"
);
let persona4 = new Agenda(
  "Santiago",
  "Buitrago",
  3004608972,
  "santiB@gmail.com"
...
numero.mostrarContacto();
numero.editarContacto(
  "Camilo",
  "Sarha",
  "Castro",
  3006452387,
  "sarhaCastr0@gmail.com"
);
numero.mostrarContacto();
